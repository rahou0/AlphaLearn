...
public class GameHelpTrigger : MonoBehaviour
{
    int type = 0;
    Button button;
    ViewPanel viewPAnel;
    ...
    void Update()
    {
        if (type != 0 && viewPAnel.currentPanel == gameObject.transform.parent.gameObject.transform.parent.gameObject.name && !viewPAnel.isClicked)
        {
            if (type == 1)
            {
